"""
The implementation of the Fibonacci-to-Type-III transformation algorithm.
"""
...
def compensation_FTG(FF, Z, CFTG, n):
    ...
    return FFCompenFTG[:-1], ZCompenFTG
...
for i in range(len(BAll)):
    ...
    FFShiftedFTG = shift_FTG(FFFib, MFTG, BFTG, n)
    ...
    FFGal, ZGal = compensation_FTG(FFShiftedFTG, ZFib, CFTG, n)
