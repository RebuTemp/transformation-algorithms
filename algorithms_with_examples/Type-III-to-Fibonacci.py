"""
The implementation of the Type-III-to-Fibonacci transformation algorithm.
""" 
...
def compute_IV_GTF(N0, Compen, n):
    ...
    ----------
    N0 : list
        initial state of the Galois NLFSR, for example, [1, 1, 0, 1]
    CFTG : list
        compensation list, for example, [-1, -1, [[2], [0]], [[3], [1], [1, 2], [0, 1]]]
    n : int
        size of the NLFSR
    Return
    ----------
    N0Gal : list
        initial state of the Fibonacci NLFSR, for example, [1, 1, 1, 0]
    """
...
if OutGal == OutFib:
    print('Transformation from Type-III Galois NLFSR to Fibonacci NLFSR succeeds!')
